...
import static com.unima.risk6.game.models.enums.GamePhase.*;
...
public class MoveProcessor {
    ...
    /**
     * Validates if the Reinforce is legal and if it is it
     * updates the game state according to the fortification move received.
     */
    ...
    /**
     * Validates if the fortify is legal and if it is
     * updates the game state according to the fortification move received.
     */
