...
public class NetworkConfiguration {
  ...
  public static void startGameServer() {
    ...
    GameConfiguration.setGameState(GameConfiguration.configureGame(usersList, new ArrayList<>()));
    MoveProcessor moveProcessor = new MoveProcessor(new PlayerController(),
        new GameController(GameConfiguration.getGameState()), new DeckController(new Deck()));
