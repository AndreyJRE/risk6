...
public class AttackTypeAdapter implements JsonSerializer<Attack>, JsonDeserializer<Attack> {
    ...
    public Attack deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        Country attackingCountry = context.deserialize(jsonObject.get("attackingCountry"), Country.class);
        Country defendingCountry = context.deserialize(jsonObject.get("defendingCountry"), Country.class);
        ...
        ArrayList<Integer> attackDiceResult = context.deserialize(jsonObject.get("attackDiceResult"), ArrayList.class);
        ArrayList<Integer> defendDiceResult = context.deserialize(jsonObject.get("defendDiceResult"), ArrayList.class);
