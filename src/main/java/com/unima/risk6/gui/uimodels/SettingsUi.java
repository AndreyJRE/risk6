...
/**
 * Represents a SettingsUi object, which extends BorderPane and provides options for adjusting game settings such as volume and leaving the
 * game.
 *
 * @author astoyano
 */
...
public class SettingsUi extends BorderPane {
    ...
    /**
     * Displays the SettingsUi by setting its size, positioning it in the center of the game scene, and showing it as a popup.
     */
    public void show() {
    ...
    /**
     * Handles the action when the "Leave Game" button is clicked. Displays a confirmation dialog and takes appropriate action based on the
     * user's choice.
     */
