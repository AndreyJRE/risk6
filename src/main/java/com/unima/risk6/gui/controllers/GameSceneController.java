...
import com.unima.risk6.gui.uiModels.*;
...
public class GameSceneController implements GameStateObserver {
    ...
    private StackPane initializeCountriesPane() {
        ...
        for (CountryUi countryUi : countriesUis) {
            ...
            CardSymbol[] possibleSymbols = {CardSymbol.CANNON, CardSymbol.CAVALRY, CardSymbol.INFANTRY, CardSymbol.WILDCARD};
            Card countryCard = new Card(possibleSymbols[randomNumber], countryUi.getCountry().getCountryName(), counter);
            counter++;
