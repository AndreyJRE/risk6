...
/**
 * The UserOptionsScene class represents the scene for user options in the game.
 * It implements the InitializableScene interface, indicating that it can be initialized.
 * It includes methods to set the controller for the scene and to initialize the scene.
 *
 * @author fisommer
 */
public class UserOptionsScene extends Scene implements InitializableScene {
  ...
  /**
   * Initializes the scene. It calls the initialization method on the controller,
